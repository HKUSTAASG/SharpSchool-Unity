...
//RT_GLO
void RT_GLO( float2 uv, float2 RTD_VD_Cal, float3 halfDirection, float3 normalDirection, float3 viewDirection, float3 positionWS, float dim_val, out float RTD_GLO, out float3 RTD_GLO_COL ) //cc
{
	#if N_F_GLO_ON
